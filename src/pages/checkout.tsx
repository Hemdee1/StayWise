      ...
      <main className="max-w-full mx-auto w-fullscreen padding">
        ...
        <section className="w-[80%] mx-auto bg-white shadow-[0px_4px_14px_0px_rgba(0,0,0,0.15)] min-h-[170px] flex justify-between items-center gap-5 rounded-[20px] -mt-20 px-[3%] relative">
          <div className=" flex w-full justify-between gap-[17px] mx-auto items-center ">
            ...
            <span className="w-[320px] h-[1px] block bg-black"></span>
            <div className="flex justify-center items-center gap-[8px] font-normal">
              <div className="min-w-[48px] h-[48px] text-[32px] bg-[#FEB737] flex items-center justify-center rounded-full">
                3
              </div>
              <p className="font-Manrope text-[16px] font-semibold ">
                Final Step
        ...
        <div className="w-[80%] mx-auto mt-[100px]">
              ...
              <div className="w-full  min-h-[237px] rounded-[8px] border-[1px] border-[#6C6C6C]">
                <div className="mt-[32px] ml-[28px]">
                  ...
                  <p className="text-[#543786] text-[14px] font-medium mt-[8px]">
                    Plot 14, Providence Street, Off Admiralty way, Lekki Phase
                    1, 101001 Lagos, Nigeria
                  </p>
                ...
                <div className="mt-[28px] bg-[#FFEBAD] flex  justify-center  rounded-[8px] w-full min-h-[139px]">
                  <div className="flex justify-between w-full mx-[22px]">
                    <div className="mt-[50px]">
                      <span className="block text-[28px] font-bold">Total</span>
                    </div>
            ...
            <div className="w-[60%]">
              <div className="w-full h-[102px] rounded-[8px] border-[1px] border-[#6C6C6C]">
                <div className="flex ml-[36px] gap-[6px] items-center h-full">
                  ...
                  <div>
                    <p className="text-[16px] font-normal">You are signed in</p>
              ...
              <div className="w-full, rounded-[8px] border-[1px] border-[#6C6C6C] min-h-[511px] mt-[10px] ">
                ...
                <div className="flex gap-[20px] mt-[13px]">
                  <div className=" flex ml-[26px] gap-[8px]">
                    <span className="h-[24px] w-[24px] border-[1px] border-black  block rounded-full"></span>
                ...
                <form action="" className="w-full">
                  <div className="flex gap-[21px] ">
                    <div className="flex ml-[26px] mt-[30px] gap-[5px] flex-col">
                      ...
                      <input
                        className=" border-[1px] border-[#6C6C6C] rounded-[8px] w-[105%] h-[48px]"
                        type="text"
                      />
                    </div>
                    <div className="flex ml-[26px] mt-[30px] gap-[5px] flex-col">
                  ...
                  <div className="flex ml-[26px] mt-[30px] gap-[5px] flex-col">
                    ...
                    <input
                      className=" border-[1px] border-[#6C6C6C] rounded-[8px] w-[37%] h-[48px]"
                      type="text"
                    />
                  </div>
                </form>
                <div className="mt-[42px] ml-[26px]">
                  ...
                  <div className="flex gap-[11px] items-center mt-[12px]">
                    <span className="block h-[24px] w-[24px] rounded-full  border-[1px]"></span>
              ...
              <div className="w-full, rounded-[8px] border-[1px] border-[#6C6C6C] min-h-[287px] mt-[10px] ">
                ...
                >
                  ...
                  <select
                    size="0"
                    class="scrollable"
                    className="mt-[5px] border p-[11px] active:border-none border-[#6C6C6C]"
                  >
              ...
              <div className="w-[264px] h-[68px] rounded-[12px] bg-[#FEB737] flex items-center justify-center mt-[45px] ml-[300px]">
                <p className="text-[25px] font-normal">Next : Final details</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full flex  mx-auto mt-[68px] rounded-[24px] min-h-[850px] border border-[#868686]">
            <div className="w-[412px] h-[850px] bg-[#FFEBAD] rounded-[24px]">
              <p className="text-[36px] mt-[105px] mx-[73px] font-bold">
                FAQs about Caesar’s Luxury Hotel
              </p>
            </div>
            <div>
              <div className="mt-[81px] w-[80%]  ml-[38px] justify-between flex items-center">
              ...
              <div className="mt-[46px] w-[80%]  ml-[38px] justify-between flex items-center">
                <p className="text-[20px]  font-semibold">
                  FAQs about Caesar’s Luxury Hotel FAQs about Caesar’s Luxury
                  Hotel ??
                </p>
                <div>
                  <ArrowDown />
              ...
              <div className="mt-[46px] w-[80%]  ml-[38px] justify-between flex items-center">
                <p className="text-[20px]  font-semibold">
                  FAQs about Caesar’s Lubout Caesar’s Luxury Hotel ??
                </p>
                <div>
                  <ArrowDown />
                </div>
